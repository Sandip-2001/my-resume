...
const resumeData = {
  ...
  skills: {
    ...
    areasOfInterest: ["Web Development", "Machine Learning", "Blockchain"],
...
export default function App() {
  // --- SYNCED LOGIC FOR DARK MODE ---

  // 1. Initialize state. We check localStorage first, then system preference.
  ...
  // 2. Sync state changes to DOM and localStorage
  useEffect(() => {
    if (darkMode) {
      ...
      <main className="container mx-auto px-6 py-12 max-w-5xl space-y-24">
        ...
        <section className="grid md:grid-cols-2 gap-12">
          ...
          <div id="education" className="flex flex-col h-full">
            ...
            <div className="bg-white dark:bg-slate-800/50 p-6 rounded-2xl border border-gray-100 dark:border-slate-800 flex-1">
              <div className="mt-2">
          ...
          {/* Skills Column */}
          <div id="skills" className="flex flex-col h-full">
            ...
            <Card className="p-6 flex-1">
              <div className="space-y-6">
                ...
                <SkillSection
                  ...
                  icon={Lightbulb}
                  skills={resumeData.skills.areasOfInterest}
                />
                <SkillSection
                  title="Soft Skills"
                  icon={User}
